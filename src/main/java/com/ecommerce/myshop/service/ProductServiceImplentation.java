...
import com.ecommerce.myshop.model.Category;
import com.ecommerce.myshop.model.Product;
import com.ecommerce.myshop.repository.CategoryRepository;
...
public class ProductServiceImplentation implements ProductService {
	...
	@Override
	public Page<Product> getAllProduct(String category, List<String> colors, List<String> sizes, Integer miniPrice,
			Integer maxPrice, Integer minDiscount, String sort, String stock, Integer pageNumber, Integer pageSize) {
	
		Pageable pageable=PageRequest.of(pageNumber, pageSize);
		
		List<Product> products=productRepository.filterProducts(category, miniPrice, maxPrice, minDiscount, sort);
